...
import { ColumnsAbility } from "./columns";
...
interface DataTableProps {
  ...
  onRowClick?: (data: AbilityDetail) => void;
}
              ...
              table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  className={cn(
                    ...
                    selectedAbility?.includes(
                      (row.original as AbilityDetail).name
                    )
